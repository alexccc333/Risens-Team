    ...
    return function (modules) {
        ...
        var SpanStyles = function () {
            ...
            SpanStyles.prototype.setStylesOnSpan = function (span, animationCollection, animationStyleElement) {
                ...
                if (this._scaleY > 1)
                {
                    fontSize = (fontSize * 0.75).toFixed(3);
                    lineHeight = (lineHeight * 0.75).toFixed(3);
                }
                ...
                var letterSpacing = (this._scaleX * this._letterSpacing).toFixed(3);
                ...
                if (this._settings.enableSvg) {
                    ...
                    if (outlineWidth > 0 || outlineHeight > 0) {
                        ...
                        (function (addOutline) {
                            ...
                            if (x < 2) x = 2;
                            if (y < 2) y = 2;
                            outlineFilter += '	<feMorphology in="SourceAlpha" operator="dilate" radius="' + x + " " + y + '" result="outline' + outlineNumber + '" />\n';
